...
export const BIOMES: Record<Biome, BiomeDef> = {
  ...
  lava: {
    ...
    wallValue: 0.8,
    // Desaturated charcoal-brown walkable rock: the melt is the only hot hue in the frame.
    floor: [0x5a524c, 0x46403c, 0x221e1d],
    rock: [0x4e4240, 0x3e3434, 0x5a4a44],
    crystals: [0xff6a1a, 0xff3a2a, 0xffb040],
    crystalCount: 9,
    // Cool bounce (not red): basalt and path keep a neutral value, lava does the colouring.
    hemi: [0x5a6078, 0x1a1412, 0.85],
    fog: 0x120505,
    lantern: [0xffc890, 18],
    exposure: 1.1,
