...
export const ORE_STYLE: Record<OreId, OreStyle> = {
  ...
  coal: { color: 0x26222a, kind: 'coal', glow: 0, hp: 1 },
  quartz: { color: 0xf2f0ff, kind: 'gem', glow: 0.5, hp: 1 },
...
export const BIOMES: Record<Biome, BiomeDef> = {
  earth: {
    ...
    crystals: [0x3fe0c8, 0xffb347, 0x6fd8ff],
    crystalCount: 7,
    hemi: [0x8a7a90, 0x3a2618, 0.7],
    fog: 0x0e0a08,
    lantern: [0xffb46a, 26],
    exposure: 1.18,
