...
export const DEMOS: Record<string, DemoDef> = {
  ...
  'farm-tools': { map: 'farm', x: 27.5, z: 20.5, facing: 'left', time: 11.2, season: 'spring', weather: 'sun', camera: { yaw: -40, pitch: 32, distance: 8, offsetX: 0.22, offsetZ: -0.98 }, showcase: ['tools'] },
  ...
  'farm-water': { map: 'farm', x: 27.5, z: 20.5, facing: 'left', time: 10.4, season: 'spring', weather: 'sun', camera: { yaw: -40, pitch: 32, distance: 7.4, offsetX: 0.22, offsetZ: -0.98 }, showcase: ['tools', 'tool:wateringCan'] },
