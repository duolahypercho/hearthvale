...
export const NPCS: Record<NpcId, NpcDef> = {
  ...
  bram: {
    ...
    look: { skin: 0xd9a07a, hair: 0x5a3a24, hairStyle: 'cap', top: 0xe4d9c6, bottom: 0x6a5a48, apron: 0xd8cbb0, beard: 'full', scale: 1.08, build: 1.42, eyes: 0x5a3a24, face: 'square', legs: 0.92, shoes: 0x4a3222, backdrop: 'bakery' },
  ...
  linus: {
    ...
    look: { skin: 0xf2d0b4, hair: 0x9a9690, hairStyle: 'slick', top: 0xd8e4ea, bottom: 0x4a5058, coat: 0xe6e8e2, bowtie: 0x2f8f8a, glasses: true, beard: 'mustache', scale: 1.1, build: 0.86, eyes: 0x4a6a8a, face: 'long', legs: 1.2, acc: ['stethoscope'], shoes: 0x2a2624, backdrop: 'clinic' },
