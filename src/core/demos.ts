...
export const DEMOS: Record<string, DemoDef> = {
  ...
  'coop-farm': { map: 'farm', x: 28.4, z: 25.8, facing: 'left', time: 9.4, season: 'spring', weather: 'sun', camera: { yaw: -8, pitch: 39, distance: 17.5, offsetX: -2.9, offsetZ: -2.9 }, showcase: ['field', 'coop'] },
